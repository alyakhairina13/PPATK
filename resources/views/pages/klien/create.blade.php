        ...
        <form method="POST" action="{{ route('klien.store') }}" class="px-6 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="npwp" id="npwp" value="{{ old('npwp') }}" placeholder="12.345.678.9-012.345" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('npwp') border-red-500 @enderror" required>
